    ...
    <footer className="relative  w-full bg-teal-200 ">
      <div className="mx-auto w-full max-w-7xl px-8  ">
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-black py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal text-black md:mb-0 whitespace-nowrap"
          >
            <p> &copy;{currentYear} Suzan Organisation</p> All Rights Reserved
          </Typography>
          <div className="flex gap-4 text-black sm:justify-center">
            <Typography
              as="a"
              href="#"
              className="opacity-80 transition-opacity hover:opacity-100 transition-transform hover:scale-105"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
